  ...
  describe 'converge' do
    ...
    it 'contracts toward the center' do
      expect(filtered).to eq([
        ...
        [0, 1, false], [1, 1, false], [2, 1, true], [3, 1, false], [4, 1, false], [5, 1, false],
        [0, 2, false], [1, 2, true], [2, 2, true], [3, 2, true], [4, 2, true], [5, 2, false],
        [0, 3, false], [1, 3, false], [2, 3, true], [3, 3, false], [4, 3, false], [5, 3, false],
        [0, 4, false], [1, 4, false], [2, 4, true], [3, 4, false], [4, 4, false], [5, 4, false],
